  ...
  return (
    <footer className="px-6 py-10 border-t border-white/5 mt-16">
      <div className="max-w-5xl mx-auto flex flex-col gap-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 text-sm text-[--text-dim]">
        ...
        <p className="text-xs text-[--text-dim] text-center md:text-left italic">
