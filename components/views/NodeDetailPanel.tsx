    ...
    <>
      ...
      >
        ...
        <div className="nd-body">
          ...
          {/* Flow & Links removed from the detail panel — once a node has
              more than one link the stacked pickers were genuinely hard
              to read (which arrow does row 3 control?). Editing now
              happens directly on the surfaces the flow lives on:
                - Parent-edge flow: chip on the node card
                - Link flow: mid-line chip on each link (canvas + tree)
              The panel goes back to being about note / image / files. */}
